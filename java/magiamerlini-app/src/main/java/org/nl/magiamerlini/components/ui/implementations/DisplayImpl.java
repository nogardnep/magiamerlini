...
public class DisplayImpl extends CommunicatingComponent implements Display {

	private final static String COMPONENT_NAME = "display";
	private final static String EMPTY = "----";

	public DisplayImpl(Communication communication) {
		super(communication);
	}
	...
	public void displaySelectedParameter() {
		Parameter parameter = mainController.getItemsSelector().getEditingParameter();

		communication.sendMessage(
				COMPONENT_NAME + " parameter_index " + mainController.getItemsSelector().getEditingParameterIndex());
		communication
	...
	public void displaySelectedItem() {
		Item item = mainController.getItemsSelector().getFirstSelectedItem();
	...
	public void displaySelection() {
		...
		if (mainController.isReady()) {
			...
			informationsMap.put("trk", mainController.getSelectedTrackIndex());
			informationsMap.put("pg", mainController.getSelectedPageIndex());
			informationsMap.put("ptn", mainController.getSelectedPatternIndex());
			informationsMap.put("seq", mainController.getSelectedSequenceIndex());
	...
	public void displayMode() {
		communication.sendMessage(COMPONENT_NAME + " mode_name " + mainController.getSelectedMode().getName());
	}
}
